export KALDI_ROOT=/mnt/matylda3/karafiat/BABEL/GIT/Kaldi.pkwrap.2021-02-06/ #/mnt/matylda5/iveselyk/Tools/kaldi-trunk/
export PATH=$PWD/utils/:$KALDI_ROOT/tools/openfst/bin:$PWD:$PATH:/mnt/matylda6/iegorova/TOOLS/nkf-master
